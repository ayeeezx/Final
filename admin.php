			...
			<table class="table table-sm">
				...
				<tbody>
					...
					while ($result_query_tarefas = mysqli_fetch_assoc($query_tarefas)) {
						...
						echo "<td><a class='btn btn-sm btn-outline-danger' href='processos/processo-exclui-tarefa.php?id_tarefas=$id_tarefas'>Excluir</a></td>";
						echo "<td><a class='btn btn-sm btn-outline-info' href='processos/editar-tarefa.php?id_tarefas=$id_tarefas'>Editar</a></td>";
						echo "</tr>";
					}
					?>
				</tbody>
